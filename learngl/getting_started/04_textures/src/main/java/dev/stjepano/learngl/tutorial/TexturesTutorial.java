...
public class TexturesTutorial {

    static void main() {
        WindowSettings windowSettings = new WindowSettings(1920, 1080, "LearnOpenGL - Textures", true);
        try (Platform platform = Platform.defaultInstance();
            ...
            program.setInt(1, 0);   // texture unit 0
            program.setInt(2, 1);   // texture unit 1
